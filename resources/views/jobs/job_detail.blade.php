            ...
            <div class="card pb-3">
                <div class="row">
                    ...
                    <div class="col-md-12 col-12">
                        <div class="row">
                            <div class="col-md-4 col-5 col-xl-4 col-lg-4 align-self-center">
                            ...
                            <div class="col-md-6 col-5 col-xl-6 col-lg-5 align-self-center">
                            ...
                            <div class="col-md-2 col-2 col-xl-2 col-lg-3">
                                @php
                                    $is_fav = 'no';
