...
@section('content')
        ...
        <div class="view-div">
            ...
            <div class="result_cnhgb">
                ...
                <div class="row blgv_tybw">
                    <div class="col-md-3 col-sm-4 col-lg-7 col-xl-7">
                        <span class="grayc">{{ \Carbon\Carbon::parse($blog->created_at)->format('D jS, M Y') }}</span>
                    </div>
                    <div class="col-md-9 col-lg-5 col-sm-8 col-xl-5 kjhgft4gv">
                        <div class="row dfgercq">
                ...
                <div class="blg-top list-blogs">
                    ...
                    <div class="row">
                        @foreach($more as $row)
                            ...
                            @endphp
                            <div class="col-md-6 col-lg-6 col-xl-6 col-sm-6 lastids">
                                <div class="card njh2ryv" id="{{$row->id}}">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <div class="row mjmhwq">
                                            ...
                                            <div class="col-md-7">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <span class="likes_stns"><img src="@if(Auth::check())@if($like == null) {{asset('images/blogs/likes.svg')}} @else {{asset('images/blogs/liked.svg')}} @endif @else {{asset('images/blogs/likes.svg')}} @endif" alt="like-image"><span class="count_l">{{$count_l}}  </span> likes</span>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <a href="{{route('view-blog', [$row->id, $row->slug])}}">
    ...
    <script>
        ...
        $(document).on('click', function(event) {
            ...
            if (!target.closest('.blgv_tybw').length) {
