...
@component('mail::layout')
    ...
    <p class="title-content"> <b><span style="text-decoration: underline;">{{ $user_name }}</span> applied</b></p>
    ...
    @endcomponent
    <p class="text-left"><b>{{$user_name}}</b> has applied for the above job post. You will find their(His/Her) information through the given link.</p>
    <p class="text-center">
