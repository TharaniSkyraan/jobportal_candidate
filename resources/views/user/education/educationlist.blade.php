@foreach ($educations as $education)
    <div class="appendeducation  mb-4 card educationList_{{$education->id}}">
        <div class="text-end" data-edid="{{$education->id}}">
            ...
            <span class="delete_education_{{$education->id}} delete_education m-2 cursor-pointer" onclick="delete_user_education('{{$education->id}}');"> <i class="fa-solid fa-trash-can text-danger"></i> </span>
