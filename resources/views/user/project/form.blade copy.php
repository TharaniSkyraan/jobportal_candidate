...
<div class="mb-4">
    <label class="form-label fw-bold pr-3">Project location</label>  
...
<div class="row align-items-baseline">
    ...
    <div class="col-md-4 col-6 hide_currently_working_checked">
        <div class="input-group">
...
<div class="mb-4">    
    ...
    {!! Form::textarea('description', null, array('class'=>'form-control required', 'id'=>'description', 'placeholder'=>'Describe about the project')) !!}
...
<div class="mb-4">    
    ...
    {!! Form::textarea('role_on_project', null, array('class'=>'form-control', 'id'=>'role_on_project', 'placeholder'=>'Write about your role and responsiblities in this project')) !!}
</div>
