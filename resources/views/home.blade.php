    ...
    <div class="container">@include('flash::message')
		...
		<div class="profileban">
			...
			<div class="abtuser">
                ...
                $packages = App\Model\Package::where('package_for', 'like', 'job_seeker')->get();

                $package = Auth::user()->getPackage();

                if(null !== $package){

                $packages = App\Model\Package::where('package_for', 'like', 'job_seeker')->where('id', '<>', $package->id)->where('package_price', '>=', $package->package_price)->get();
                            ...
                            <div class="profbox">
                                ...
                                <ul class="recomndjobs">
                                    ...
                                    <li>
                                        ...
                                        <h4><a href="{{route('job.detail', [$match->id])}}">{{$match->title}}</a></h4>
