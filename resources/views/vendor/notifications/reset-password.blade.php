<style>
  ...
  @component('mail::layout')
    ...
    <p class="title-content">Reset Password</h3>
    <p class="text-center">Have you forgotten your password. Click on the below link to reset your password.</p><br>
    <p class="text-center">
        <a class="button button-blue" href="{{ $link }}">
            Reset Password
        </a>
    </p>
    <p class="text-center">If you don't want to reset your login password, please ignore this message.</p><br>
    <br>
